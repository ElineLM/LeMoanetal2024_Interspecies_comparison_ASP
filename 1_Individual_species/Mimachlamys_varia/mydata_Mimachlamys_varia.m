...
Lw0.tL19SA = 0.0215;  units.Lw0.tL19SA = 'cm'; label.Lw0.tL19SA = 'initial physical length'; %cm, length at metamorphosis 
...
units.tL19SA   = {'d', 'cm'};  label.tL19SA = {'time', 'shell height Régnier-Brisson StAnne', 'N19 at Ste Anne'};  
...
data.tW19SA(:,1) = tLW19SA(:,1);  data.tW19SA(:,2) = tLW19SA(:,3)- tLW19SA(:,4);
...
units.tW19SA   = {'d', 'g'};  label.tW19SA = {'time', 'somatic afdw  Régnier-Brisson StAnne', 'N19 at Ste Anne'};  
...
data.LW19SA(:,1) = tLW19SA(:,2); data.LW19SA(:,2) = tLW19SA(:,3) - tLW19SA(:,4); %create time-length data
units.LW19SA   = {'cm', 'g'};  label.LW19SA = {'shell height','afdw w/out gonad Régnier-Brisson StAnne', 'N19 at Ste Anne'};  
...
temp.tL19SA =[... % time since 24/05/2019 (d), temperature at Ste-Anne (Bay of Brest), Laure RB monitoring (°C)
149	14.8
150	14.7
151	14.6
152	14.5
...
temp.tL19SA    = [temp.tL19SA(:,1) C2K(temp.tL19SA(:,2))];  
units.temp.tL19SA = 'K'; label.temp.tL19SA = 'temperature';
...
weights.tW19SA = 5* weights.tW19SA;
% weights.LW19SA = 5* weights.LW19SA;
