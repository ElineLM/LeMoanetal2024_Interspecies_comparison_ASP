...
%   comment.Ri = '5.64 million eggs per spawning, and 2 spawning events (Paulet et al., 1988)';
   ...
   data.R_L  = 30904*2; units.R_L  = '#/d'; label.R_L  = 'reprod rate at a given size';     bibkey.R_L  = {'CochDeva1993', 'Paulet1998'}; 
...
units.tL2  = {'d', 'cm'};  label.tL2 = {'time', 'length Lavaud, Brest'};  
...
7	10.8
7	12] ;
data.tL(:,1) = (data.tL(:,1) * 365) - (365/2); % convert yr to d
units.tL   = {'d', 'cm'};  label.tL = {'time since birth', 'shell height EVECOS'};  
% temp.tL    = C2K(16);  units.temp.tL = 'K'; label.temp.tL = 'temperature';
temp.tL    = C2K(14);  units.temp.tL = 'K'; label.temp.tL = 'temperature'; % more 14°C in Bay of Brest in average
bibkey.tL = 'Jean2011';
