...
units.tLh_RC   = {'d', 'cm'};  label.tLh_RC = {'time since birth (N. subnodosus)', 'shell height Racotta 2003'};  
...
units.tWw_RA = {'d', 'g'}; label.tWw_RA = {'Age since fertilisation', 'Flesh wet weight'};  
...
units.tLh_RA = {'d', 'cm'}; label.tLh_RA = {'Age since fertilisation', 'Shell height Ramirez-Arce'};  
Lw0.tLh_RA = 2.5; units.Lw0.tLh_RA = 'cm'; label.Lw0.tLh_RA = 'initial physical length'; 
...
data.LWd_CL = [... shell length (cm), tissue dry weight (g dw)
% -----------------------------
...
% weights.tLh_RA = 5 * weights.tLh_RA;
% weights.LWw_RA = 2 * weights.LWw_RA;
% weights.tLh_AM = 5 * weights.tLh_AM;
% weights.LWd_CL = 5 * weights.LWd_CL;
% weights.tLl_MA = 0 * weights.tLl_MA;
...
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
 bibkey = 'Abasolo2009'; type = 'Article'; bib = [ ... 
'author = {Abasolo-Pacheco, Fernando and Mazón-Suástegui, José M. and Saucedo, Pedro E.}, ' ... 
'year = {2009}, ' ...
'title = {Response and Condition of Larvae of the Scallops {{Nodipecten}} Subnodosus and {{Argopecten}} Ventricosus Reared at the Hatchery with Different Seawater Sources}, ' ...
'journal = {Aquaculture}, ' ...
'volume = {296}, ' ...
'number = {3},'...
'pages = {255--262}',...
'doi = {10.1016/j.aquaculture.2009.08.028},'];
metaData.biblist.(bibkey) = ['''@', type, '{', bibkey, ', ' bib, '}'';'];
%
 bibkey = 'Carreno2023'; type = 'Article'; bib = [ ... 
'author = {Carreño-León, Diana and Vázquez-Sánchez, Rosa Isela and Ramirez-Arce, José Luis and Monge-Quevedo, Armando and Lluch-Cota, Salvador E}, ' ... 
'year = {2009}, ' ...
'title = {Conversion Factors for Dry Weight for the Lion Paw Scallop ({{Nodipected}} Subnodosus {{Sowerby}}, 1835)}, ' ...
