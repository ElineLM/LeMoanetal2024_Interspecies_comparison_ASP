...
trialname = 'trial_run1_';                         % Here change the name of the trial
mkdir(saveDir);
...
timeStamp = char(datetime('today'));            % get the date
saveDir   = ['results_', timeStamp, '/'];       % create the name of the folder with results and the date
trialname = 'trial_run2_';                         % Here change the name of the trial
mkdir(saveDir);
...
timeStamp = char(datetime('today'));            % get the date
saveDir   = ['results_', timeStamp, '/'];       % create the name of the folder with results and the date
trialname = 'trial_run3_';                         % Here change the name of the trial
mkdir(saveDir);
